 ...
 */
final class Version20250226125516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD prix INT NOT NULL, ADD description LONGTEXT NOT NULL, CHANGE author photo_path VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP prix, DROP description, CHANGE photo_path author VARCHAR(255) NOT NULL');
    }
}
